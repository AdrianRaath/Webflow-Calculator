...
Webflow.require("ix2").init({
  events: {
    "e-4": {
      ...
      target: {
        id: "62fb4ca8c8b27cb85d1089a8|76b0eaec-f8c4-1672-cfa3-db31c92478bb",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-10": {
      ...
      mediaQueries: ["main"],
      target: {
        selector: ".calc_tabs-link",
        originalId:
          "62fb4ca8c8b27cb85d1089a8|9c5972ea-9df5-6c62-67bf-a3eca71abd47",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-12": {
      ...
      target: {
        selector: ".calc_tabs-link",
        originalId:
          "62fb4ca8c8b27cb85d1089a8|9c5972ea-9df5-6c62-67bf-a3eca71abd3c",
        appliesTo: "CLASS",
      },
      targets: [
        {
  ...
  actionLists: {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".calc_arrow",
                  selectorGuids: ["74cb0fd7-83ac-71b2-3efa-45348354c386"],
                },
                xValue: -4,
                xUnit: "px",
                yUnit: "PX",
    ...
    "a-7": {
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1660653223010,
    },
    "a-8": {
      id: "a-8",
      title: "Hide Arrow Mobile",
      actionItemGroups: [
        {
          actionItems: [
            {
